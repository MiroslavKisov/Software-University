namespace WebServer.Server.Routing
{
    ...
    {
        private const string InvalidRouteParameterMsg = "Route parameter in {0} is not valid.";
        ...
        private void ParseTokens(string[] tokens, List<string> parameters, StringBuilder result)
        {
            for (int i = 0; i < tokens.Length; i++)
            {
                ...
                {
                    throw new InvalidRouteParameter(string.Format(InvalidRouteParameterMsg), currentToken);
                }
